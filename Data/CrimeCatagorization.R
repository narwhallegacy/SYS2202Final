...
Noncrim = ((crime$crime_type == 'Assist Agency - Backup/Assist') | (crime$crime_type == 'Assist Citizen - Medical') | 
             (crime$crime_type == 'Assist Citizen - Welfare Check') | (crime$crime_type == 'Assist Citizen - Medical') | (crime$crime_type == 'Found/Recovered Property') | 
             (crime$crime_type == 'Lost/FoundProperty') | (crime$crime_type == 'Missing Person-adult') | (crime$crime_type == 'Missing Person-juvenile') | 
             (crime$crime_type == 'Comm Relations Initiative - CRI') | (crime$crime_type == 'Misc - Non-Criminal Call'))
...
Threat = ((crime$crime_type == 'Extortion/Blackmail') | (crime$crime_type == 'Harassment') | 
            (crime$crime_type == 'Phone Calls - Threat or Obscene'))

crimeCat = paste(crimeCat, factor(Threat, labels = c('', 'Threats')), sep = "")
...
other = ((crime$crime_type == 'Death Investigation - DOA') | (crime$crime_type == 'Runaway') | 
